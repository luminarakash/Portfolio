      ...
      <header className="sticky top-0 z-30 flex h-14 items-center gap-4 border-b bg-background px-4 sm:static sm:h-auto sm:border-0 sm:bg-transparent sm:px-6 max-[900px]:h-[100px]">
        ...
        <div className="flex items-center gap-4 md:grow-0 sm:ml-16 sm:mt-5">
          <img
            ...
            alt="avatar"
            className="w-20 h-20 rounded-full max-[900px]:hidden px-1 py-1 bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 rounded-full"
          />
          <h1 className="text-4xl max-[900px]:text-2xl px-2 py-1 bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 rounded-lg text-white">
